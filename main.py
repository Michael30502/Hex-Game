...
while run:
    ...
    if second_menu == True:
        if two_player_button.draw_menu(game_surface):
            game_running = True
            second_menu = False
        if ai_1_button.draw_menu(game_surface):
            print(cpu)
            cpu = 1
            game_running = True
            second_menu = False
            print(cpu)
        if ai_2_button.draw_menu(game_surface):
            print('playing against bot 1')
        if ai_3_button.draw_menu(game_surface):
            print('playing against bot 1')
        if play_online_button.draw_menu(game_surface):
            print('playing against bot 1')
    ...
    if setting_menu == True:
        if change_board_size_button.draw_menu(game_surface):

...
#takes the combined list made from "combine_lists"
    export_string = ""
...
def export_board(board):
    #combines all the previous function so we have a final function that only takes a board array and makes the export file
    #takes board array
